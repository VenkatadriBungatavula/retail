...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href ="/createProduct"><button style="background-color:blue;color:white">CreateProduct</button></a>
...
<br>
<br>
<a href ="/createEmployee"><button style="background-color:blue;color:white">SUBMIT</button></a>
&nbsp;&nbsp;&nbsp;
<a href ="/employee"><button style="background-color:blue;color:white">CANCEL</button></a>
<br>
<br>
<br>
<hr>
